...
[![Build & Release](https://github.com/VyunSergey/scala-learn/workflows/Scala%20CI/badge.svg)](https://github.com/VyunSergey/scala-learn/actions?query=workflow%3A%22Scala+CI%22)
...
[![Last commit](https://img.shields.io/github/last-commit/VyunSergey/scala-learn)]()
[![Contributors](https://img.shields.io/github/contributors/VyunSergey/scala-learn)]()

![Sber logo](readme/images/logo/logo.png)

# ИЗУЧЕНИЕ ОСНОВ SCALA

Данный проект предназначен для изучения основ Scala от Сбер Аналитики. В рамках занятий вы научитесь:
* Основам языка программирования Scala
* Применению Scala для решения базовых задач разработки
* Написанию и отладке первых программ на Scala
